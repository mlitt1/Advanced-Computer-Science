...
public class DebugDemoStudent {
    ...
    public static int divideNumbers(int a, int b) {
        // b can be zero
        if (b == 0) {
            throw new ArithmeticException("You are attempting to break math by division of 0.");
        }
        return a / b;
    }
    ...
    public static int middleNameLength(String[] names) {
        if (names[1] == null) {
            throw new NullPointerException("This name doesn't exist");
        }
    ...
    public static double averageScore(int[] scores) {
        if (scores == null) {
            throw new IllegalArgumentException("The scores don't exist");
        }
    ...
    public static int squareRootFloor(int n) {
        if (n < 0) {
            throw new IllegalArgumentException("n is negative, you can't square root  negative square feet");
        }
    ...
    public static String slice(String word, int start, int end) {
        if (word == null) {
            throw new IllegalArgumentException("The word is empty dude");
        }
    ...
    public static String stringEnds(String str, int n) {
        if (str.length() < n) {
            throw new IllegalArgumentException("The string must be at least n");
        }
